...
public class VentanaPrincipal extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        abrir_video.setText("Abrir Video");
                ...
                try{
                    ...
                    for (int x = 0; x < 256; x++) {
                        if (x < 128) {
                            ...
                            funcionT[x] = (byte) (255.0f/(Math.pow(255-128.0f, 2) +128.0f)*(Math.pow(x-128.0f, 2)+128.0f));
                        }
                    }
    ...
    private void boton_tintadoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_boton_tintadoActionPerformed
        ...
        if (vi != null) {
            ...
            if(img!=null){
                try{
                    TintOp tintado = new TintOp(boton_color.getBackground(),0.5f);
